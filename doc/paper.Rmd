...
question of causality. \textcolor{blue}{However, the investigation will be extended by including health expenditures per capita as another independent variable (Idea from} @dalgaard2014optimal\textcolor{blue}{).}
...
reg_names <- tibble(
  var_name = esc_var_names[c(11,12,9)],
  label = smp_def$label[c(11,12,9)]
)
for (i in c(15,18,21)) {
  pos <- (i-12)/3
  tab[i] <- str_replace(
