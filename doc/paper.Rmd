...
question of causality. \textcolor{blue}{However, the investigation will be extended to including another independent variable, in more detail the health expenditures per capita (Idea from} @dalgaard2014optimal\textcolor{blue}{).}
...
latex_tab <- c(
  ...
  "\\footnotetext",
  sprintf(
    "\\item Note: The data is obtained from the World Bank. The sample covers %d countries and the period %d to %d. \\textit{National Income per captia} values are in constant 2010 thousand U.S. dollars. \\textit{Health expenditures per captia} are in current US. dollars", length(unique(smp$country)),
